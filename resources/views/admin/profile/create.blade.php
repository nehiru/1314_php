...
@section('content')
        ...
        <form action="{{ action('Admin\ProfileController@create') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="radio" name="gender" value="男"　 @if (old('gender') == '男') checked="checked" @endif >男
                            <input type="radio" name="gender" value="女"　 @if (old('gender') == '女') checked="checked" @endif >女
                        </div>
                    </div>
                    <div class="form-group row">
